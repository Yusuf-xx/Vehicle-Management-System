<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $login_query="SELECT * FROM `signup` WHERE name='$username' and password='$password'";
	...
	<body>
		...
		<div id="site-content">
			...
			<header class="site-header">
				<div class="container">
					...
					<nav class="main-navigation">
						...
						<ul class="menu">
							<li class="menu-item current-menu-item"><a href="book.php">Book Mechanic</a></li>
							<li class="menu-item"><a href="update_address.php">Update Information</a></li>
			...
			<center> <h1>Welcome, <?php echo $_SESSION['username'] ?></h1>
			         <p>You may book your own mechanic</p>		 
			</center> 
...
if ($total != 0)
{
	while ($result = mysqli_fetch_assoc($data))
	{
		...
		<td> ".$result['expert']."</td>
		<td> ".$result['phone']."</td>
		<td><u><a href = 'book.php?rn=$result[ID]'>Book</u></td>
		</tr>
		";
	}
}
